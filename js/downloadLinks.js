fetch("../latest.json").then(response => response.json()).then(data => {
    ...
    windowsInstallerAnchorTag.href = `https://github.cim/theg1239/cli-top-website/raw/main/buildFiles/v${data.version}/cli-top-windows-installer_v${data.version}.exe`;
